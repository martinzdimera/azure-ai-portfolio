...
|---|---|---|
| [UDF2_ARCHITECTURE_v3.1-public.pdf](UDF2_ARCHITECTURE_v3.1-public.pdf) | 34 | **Universal Deployment Framework** — audit-ready, repeatable Azure environment deployment: 12 stages, declarative inventory, preflight + independent triple-check before any write to Azure. |
